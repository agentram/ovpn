...
func loadConfig() (config, error) {
	...
	flag.StringVar(&cfg.clientsPDFPath, "clients-pdf-path", envOr("OVPN_TELEGRAM_CLIENTS_PDF_PATH", "/opt/ovpn-telegram-bot/assets/clients.pdf"), "Path to English clients PDF guide")
	flag.StringVar(&cfg.clientsRUPDFPath, "clients-ru-pdf-path", envOr("OVPN_TELEGRAM_CLIENTS_RU_PDF_PATH", "/opt/ovpn-telegram-bot/assets/clients-ru.pdf"), "Path to Russian clients PDF guide")
